...
function Footer() {
    return (
        <div className=''>
            <div className='flex justify-around flex-wrap gap-4  w-full  bg-[#f5efef] items-center   text-black py-12 '>
                <div className='text-center'>
                    <h2 className='text-2xl font-black xl:pb-5'>LOCATION</h2>
                    <p>45 Elm Street</p>
                    <p>Springfield 12345</p>
                    <p>USA</p>
                </div>
                <div className='text-center'>
                    <h2 className='text-2xl font-black xl:pb-5'>WORKING HOURS</h2>
                    <p>Mon-Fri 9:00AM - 10:00PM</p>
                    <p>Saturday 10:00AM - 9:00PM</p>
                    <p>Sunday 12:00PM - 8:00PM</p>
                </div>
                <div className='text-center'>
                    <h2 className='text-2xl font-black xl:pb-5'>ORDER NOW</h2>
                    <p>30 Minutes delivery quarantee</p>
                    <p className='text-3xl font-bold text-[#e21b70]'>999-999-9999</p>
                </div>
                <div className='text-center'>
                    <h2 className='text-2xl font-black xl:pb-5'>FOLLOW US</h2>
            ...
            <div className='border-t border-gray-300 py-4 text-center bg-[#f5efef] text-black flex flex-wrap items-center justify-center gap-2 '>
