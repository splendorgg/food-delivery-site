...
function RestaurantFoodCard() {
    return (
        <div className='bg-[#f7f7f7]  sm:w-[48%] lg:w-[32%] shadow-lg overflow-hidden w-max flex-grow basis-[456px] hover:bg-red-100  p-3 rounded-xl cursor-pointer flex gap-3 hover:scale-105 transition-transform duration-100 border-2 border-gray-200  '>
